...
<?php   $result = $db->query("SELECT * FROM professeur ");
     ...
     <?php while($row = $result->fetch_assoc()){
      $nbrprof++;}
          ...
          <!-- formulaire des etudiant a ajouter  -->
            ...
            <div class="col-xl-12 col-lg-12 card shadow mb-4 "style="background-color:white;font-weight: bold;">
              <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h2 class="m-0 font-weight-bold text-primary ">INFO SUPPORT</h2>
              </div>
            </div>
            <!--check box-->
            ...
            <div class="input-group mb-3">
              <div class="input-group-prepend">
                <span class="input-group-text text-primary">Nombre de support a créer</span>
              </div>
              <div class="input-group-prepend">
           ...
           <form action="uploadCl.php?id_Devoir=<?php echo ($row1['id']); ?>" role="form" method="post" enctype="multipart/form-data"><?php }?>
               <h3 class=" font-weight-bold text-info text-center shadow  titre"> SUPPORT NUMERO  : 1</h3>
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6">
                       <label for="societe">Support</label>
                       <input type="file" class="form-control" id="image" name="filev[]"   >
                  </div>
       ...
       <button type="submit" class="btn btn-primary" name="insererSupport">submit<button>
</form>
  </body>
  </html>
<!-- java Script script-->
