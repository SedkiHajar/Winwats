...
<section class="row justify-content-center">
	<section class="col-12 col-sm-6 col-md-3">
	    <form method="post" action="Conducteur" class="form-container ">		  
		  ...
		  <div class="form-group">
		    <label for="exampleInputPassword1">Numéro téléphone du conducteur</label>
		    <input type="number" class="form-control" name="numTel" placeholder="Entrez le Numéro téléphone du conducteur">
		  </div>
