...
<section class="row justify-content-center">
	<section class="col-12 col-sm-6 col-md-3">
	   <!--- Start espaceA Section 
	    <c:if test="${ !empty sessionScope.mail && !empty sessionScope.password }">
        <p>Vous êtes ${ sessionScope.mail } ${ sessionScope.password } !</p>
        </c:if>
	    -->
	    <form method="post" action="loginE" class="form-container">
