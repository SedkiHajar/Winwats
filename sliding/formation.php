...
<html lang="en">
  ...
  <body>
	...
	<div class="container">
	<p><br><br>
      En tant que fabricant, nous participons à de nombreux salons mais organisons également chaque mois des présentations de produits et des formations. Si vous souhaitez y participer, n’hésitez pas à nous écrire à l’adresse info@winwats.com. Après deux jours de formation, vous pourrez raccorder et programmer vous-même le système. Notre défi consiste à FACILITER autant que possible la vie de l’installateur afin qu’il puisse terminer son installation le plus RAPIDEMENT possible. Notre logiciel de configuration est par conséquent connu pour la simplicité de son interface utilisateur. La présence de notre système unique de liaison autonome (« autobinding ») permet de réaliser la configuration d’une manière très RAPIDE et SANS ERREUR. Chez Winwats, malgré les nombreuses possibilités, la programmation reste malgré tout un exercice aisé.
      	<br><br>
      Winwats investit pleinement dans les « Winwats Partners » sous forme de formations, présentations communes, présentations de produits, etc. Objectif : mettre en place une collaboration durable entre le fabricant et l’installateur à travers des contacts directs. C’est la seule manière pour les deux parties d’être et de rester performantes dans un marché en rapide évolution, ainsi qu’en témoigne la très grande stabilité qui caractérise la liste d’installateurs avec lesquels Winwats travaille. Les maîtres d’ouvrage seront également contents de savoir que votre installateur a été formé pour utiliser le système que vous souhaitez et qu’il a eu l’occasion de se familiariser avec ce système. Outre ces formations mensuelles, nous disposons également de notre propre service technique afin d’épauler les partenaires Winwats sur le chantier
      <br><br>
